...
import numpy as cp # Đổi lại thành cp để tránh nhầm lẫn với numpy
...
class PolicyAgent:
    ...
    def encode_state(self, obs):
        ...
        if isinstance(board_raw, torch.Tensor):
            ...
            board_np = cp.array(board_raw).flatten()
        ...
        return torch.tensor((board_encoded_cp), dtype=torch.float32)
