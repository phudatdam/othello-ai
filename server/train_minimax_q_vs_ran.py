...
if __name__ == "__main__":
    ...
    game_total = 0
    #agent_black = MinimaxPlayer(BLACK, 2, 0.5)
    ...
    for game_index_per_depth in range(num_games):
        ...
        env = OthelloEnv()
        agent_black = RandomPlayer(env.game) # if game_total % 2 == 0 else MinimaxPlayer(BLACK, 2, 0.5)
        ...
        while not done:
            ...
            move = agent_black.play(env.game)
            ...
            if prev_state is not None:
                ...
                agent_white.replay_buffer_save(
                    ...
                    reward=black_reward+white_reward,
